...
class MyWalletState extends Equatable {
  const MyWalletState(
      {required this.cosmosAddress, required this.solanaAddress, required this.tronAddress, required this.bitcoinAddress, required this.bitcoinBech32Address, required this.ethereumAddress});
